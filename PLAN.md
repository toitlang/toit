...
- **Soft-width threshold.** `MAX_LINE_WIDTH = 100` drives every flat-vs-broken decision — Call, Binary chain, collection literal. No count-based always-break rules: a Call with 2 short named args stays flat, a Call with 2 long named args breaks; same for collection literals. Short forms are readable regardless of element count; long forms break because they hit the width.
