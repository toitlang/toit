...
#if defined(TOIT_ESP32) && !defined(CONFIG_IDF_TARGET_ESP32C3)
...
class PcntUnitResource : public Resource {
 public:
  ...
  esp_err_t close_channel(pcnt_channel_t channel) {
    ...
    static_assert(ESP_IDF_VERSION_MAJOR == 5 && ESP_IDF_VERSION_MINOR == 3,
...
#endif // defined(TOIT_ESP32) && !defined(CONFIG_IDF_TARGET_ESP32C3)
