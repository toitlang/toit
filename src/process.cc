...
Process::Process(Program* program, ProcessRunner* runner, ProcessGroup* group, SystemMessage* termination, InitialMemoryManager* initial_memory)
  ...
  if (program) {
    ...
    true_object_ = null;
    null_ = null;
    marked_allocation_failed_ = null;
    marked_already_exists_ = null;
    marked_file_not_found_ = null;
    marked_hardware_error_ = null;
    marked_illegal_utf_8_ = null;
    marked_invalid_argument_ = null;
    marked_malloc_failed_ = null;
    marked_cross_process_gc_ = null;
    marked_negative_argument_ = null;
    marked_out_of_bounds_ = null;
    marked_out_of_range_ = null;
    marked_already_in_use_ = null;
    marked_overflow_ = null;
    marked_permission_denied_ = null;
    marked_quota_exceeded_ = null;
    marked_unimplemented_primitive_ = null;
    marked_wrong_type_ = null;
    marked_already_closed_ = null;
  }
}
