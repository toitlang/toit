...
TYPE_PRIMITIVE_ANY(pin_set_pull)
TYPE_PRIMITIVE_ANY(pin_config_edge_detection)
TYPE_PRIMITIVE_ANY(pin_consume_edge_events)
TYPE_PRIMITIVE_ANY(pin_last_edge_trigger_timestamp)
