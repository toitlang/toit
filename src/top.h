...
// RP2350 uses the Pico SDK with the upstream FreeRTOS kernel.
...
#if defined(TOIT_DARWIN) + defined(TOIT_LINUX) + defined(TOIT_WINDOWS) + defined(TOIT_ESP32) + defined(TOIT_EC618) + defined(TOIT_RP2350) > 1
#error "More than one OS configuration specified"
#elif defined(TOIT_DARWIN) + defined(TOIT_LINUX) + defined(TOIT_WINDOWS) + defined(TOIT_ESP32) + defined(TOIT_EC618) + defined(TOIT_RP2350) < 1
#error "No OS configuration specified"
#endif

#if (__WORDSIZE == 64) || __WIN64
#define BUILD_64 1
#elif (__WORDSIZE == 32) || ESP32 || __EC618 || defined(TOIT_RP2350) || __WIN32
#define BUILD_32 1
#else
