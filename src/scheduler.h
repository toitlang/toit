...
class Scheduler {
 public:
  ...
  // Run a new program. Returns the process ID of the root process. If arguments is non-null, it
  // must be an encoded message generated by a MessageEncoder.
  int run_program(Program* program, uint8* arguments, ProcessGroup* group, Chunk* initial_chunk, Object** global_variables);
