...
The host build uses [toit_config.h](toit_config.h), and the EC618 build uses
[ec618_config.h](ec618_config.h). [default_config.h](default_config.h) is
unused and serves as a reference for the configuration options. It makes it
possible to easily see which configurations have changed.
