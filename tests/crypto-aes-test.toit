...
test-aes-ecb:
  ...
  expect.expect-bytes-equal
      PLAINTEXT
      (decryptor.decrypt ECB-CIPHERTEXT24)  
  ...
  expect.expect-bytes-equal
      PLAINTEXT
      (decryptor.decrypt ECB-CIPHERTEXT16)
...
test-aes-cbc:
  ...
  expect.expect-bytes-equal
      PLAINTEXT
      (decryptor.decrypt CBC-CIPHERTEXT32)
  ...
  expect.expect-bytes-equal
      PLAINTEXT
      (decryptor.decrypt CBC-CIPHERTEXT24)
  ...
  expect.expect-bytes-equal
      PLAINTEXT
      (decryptor.decrypt CBC-CIPHERTEXT16)
