...
test-custom-mdns:
  ...
  res := client.get "toit.local" --record-types=[dns.RECORD-A] --network=network
  ...
  res-txt := client.get "toit.local" --record-types=[dns.RECORD-TXT] --network=network
  ...
  res-aaaa := client.get "toit.local" --record-types=[dns.RECORD-AAAA] --network=network
  ...
  res-srv := client.get "service.local" --record-types=[dns.RECORD-SRV] --network=network
  ...
  res-ptr := client.get "ptr.local" --record-types=[dns.RECORD-PTR] --network=network
  ...
  res-mismatch := client.get "mismatch.local" --record-types=[dns.RECORD-A] --network=network
  ...
  res-unsolicited := client.get "unsolicited.local" --record-types=[dns.RECORD-TXT] --network=network
