...
GPIO4 is otherwise unused on the EC618 companion rig. Its internal pull-up
  gives the input read a deterministic level without additional wiring.
*/
...
main:
  ...
  print "gpio-resource-esp32: PASS resource-backed config/get/set/open-drain/pull and closed-pin rejection"
