...
main:
  expect-equals 5001 BIG1.size
  expect-equals 3001 BIG2.size
  expect-equals 2001 BIG3.size
  expect-equals 1001 BIG4.size
  lists := [BIG1, BIG2, BIG3, BIG4]
  lists.do: |big|
    expect (big is CowByteArray_)
    for i := 0; i < big.size; i++:
      if i % 1000 == 0:
        expect-equals (i / 100) big[i]
      else if i % 100 == 0:
        expect-equals ((i / 100) % 10) big[i]
      else if i % 10 == 0:
        expect-equals (i % 100) big[i]
