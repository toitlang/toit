...
import expect show expect_equals
import crypto.sha
import tls
...
sha224_test:
  ...
  output_88 := tls.pseudo_random_function_ 88 --block_size=sha.Sha224.BLOCK_SIZE --secret=SECRET --label=LABEL --seed=SEED:: sha.Sha224
...
sha256_test:
  ...
  output_100 := tls.pseudo_random_function_ 100 --block_size=sha.Sha256.BLOCK_SIZE --secret=SECRET --label=LABEL --seed=SEED:: sha.Sha256
...
sha384_test:
  ...
  output_148 := tls.pseudo_random_function_ 148 --block_size=sha.Sha384.BLOCK_SIZE --secret=SECRET --label=LABEL --seed=SEED:: sha.Sha384
...
sha512_test:
  ...
  output_196 := tls.pseudo_random_function_ 196 --block_size=sha.Sha512.BLOCK_SIZE --secret=SECRET --label=LABEL --seed=SEED:: sha.Sha512
