...
TEST-LOCALHOST-KEY-DIRECTLY-SIGNED ::= """\
-----BEGIN EC PARAMETERS-----
BgUrgQQAIg==
-----END EC PARAMETERS-----
...
TEST-LOCALHOST-CERT-DIRECTLY-SIGNED ::= net.Certificate.parse """\
-----BEGIN CERTIFICATE-----
...
TEST-ROOT-CERT ::= net.Certificate.parse """\
-----BEGIN CERTIFICATE-----
...
TEST-CLIENT-CERT-DIRECTLY-SIGNED ::= net.Certificate.parse """\
-----BEGIN CERTIFICATE-----
...
TEST-CLIENT-KEY-DIRECTLY-SIGNED ::= """\
-----BEGIN EC PARAMETERS-----
BgUrgQQAIg==
-----END EC PARAMETERS-----
-----BEGIN EC PRIVATE KEY-----
