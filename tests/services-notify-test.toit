...
test-notify:
  ...
  resource.notify 42
  expect.expect-equals 42 resource.notification

  resource.notify 87
  expect.expect-equals 87 resource.notification

  resource.notify 99
  resource.notify 101
  expect.expect-equals 99 resource.notification
  expect.expect-equals 101 resource.notification

  resource.notify "hestfisk"
  expect.expect-equals "hestfisk" resource.notification
...
class ResourceServiceClient extends services.ServiceClient implements ResourceService:
  ...
  notify handle/int notification/any -> none:
    invoke_ ResourceService.NOTIFY-INDEX [handle, notification]
...
class ResourceServiceProvider extends services.ServiceProvider
  ...
  handle index/int arguments/any --gid/int --client/int -> any:
    ...
    if index == ResourceService.NOTIFY-INDEX:
