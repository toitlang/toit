...
main:
  ...
  expect-equals 1 point.x
  expect-equals 2 point.y
  expect-equals 3 point.z

  bytes := point.to-byte-array
  ...
  result := -point
  expect-equals -1 result.x
  expect-equals -2 result.y
  expect-equals -3 result.z
  ...
  other-point := math.Point3f 0.5 1.5 2.5
  result = point + other-point
  expect-equals 1.5 result.x
  expect-equals 3.5 result.y
  expect-equals 5.5 result.z

  result = point - other-point
  expect-equals 0.5 result.x
  expect-equals 0.5 result.y
  expect-equals 0.5 result.z

  result = point * 2
  expect-equals 2 result.x
  expect-equals 4 result.y
  expect-equals 6 result.z

  result = point / 2
  expect-equals 0.5 result.x
  expect-equals 1   result.y
  expect-equals 1.5 result.z
