...
set(CMAKE_C_FLAGS "-mlongcalls -DESP32 -DDEPLOY=1 -D__FREERTOS__=1 -Wno-sign-compare -ggdb" CACHE STRING "c flags")
set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} -DRAW=1 -D__SANITIZE_THREAD__=1 -fno-rtti" CACHE STRING "c++ flags")
...
set(SKDCONFIG_INCLUDE_DIR "build/esp32s3/esp-idf/config" CACHE FILEPATH "Path to the sdkconfig.h include")
