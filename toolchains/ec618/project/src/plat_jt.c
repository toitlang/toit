...
PLAT_STUB(USART2_DmaRxEvent, 223)
PLAT_STUB(USART2_IRQHandler, 224)
PLAT_STUB(USART_Control, 225)
PLAT_STUB(USART_DmaRxEvent, 226)
PLAT_STUB(USART_DmaTxEvent, 227)
PLAT_STUB(USART_GetBaudRate, 228)
PLAT_STUB(USART_GetCapabilities, 229)
PLAT_STUB(USART_GetModemStatus, 230)
PLAT_STUB(USART_GetRxCount, 231)
PLAT_STUB(USART_GetStatus, 232)
PLAT_STUB(USART_GetTxCount, 233)
PLAT_STUB(USART_IRQHandler, 234)
PLAT_STUB(USART_Initialize, 235)
PLAT_STUB(USART_PowerControl, 236)
PLAT_STUB(USART_Receive, 237)
PLAT_STUB(USART_Send, 238)
PLAT_STUB(USART_SendPolling, 239)
PLAT_STUB(USART_SetBaudrate, 240)
PLAT_STUB(USART_SetModemControl, 241)
PLAT_STUB(USART_Uninitialize, 242)
PLAT_STUB(Uart_BaseInitEx, 243)
PLAT_STUB(Uart_ChangeBR, 244)
PLAT_STUB(Uart_DeInit, 245)
PLAT_STUB(Uart_IsTSREmpty, 246)
PLAT_STUB(Uart_RxBufferClear, 247)
PLAT_STUB(Uart_RxBufferRead, 248)
PLAT_STUB(Uart_TxTaskSafe, 249)
PLAT_STUB(WDT_deInit, 250)
PLAT_STUB(WDT_getStartStatus, 251)
PLAT_STUB(WDT_init, 252)
PLAT_STUB(WDT_kick, 253)
PLAT_STUB(WDT_start, 254)
PLAT_STUB(WDT_stop, 255)
PLAT_STUB(WDT_unlock, 256)
PLAT_STUB(XIC_EnableIRQ, 257)
PLAT_STUB(XIC_SetVector, 258)
PLAT_STUB(_ZNSt13random_device7_M_finiEv, 259)
PLAT_STUB(_ZNSt13random_device7_M_initERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE, 260)
PLAT_STUB(_ZNSt13random_device9_M_getvalEv, 261)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv, 262)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_S_copy_charsEPcPKcS7_, 263)
PLAT_STUB(_ZSt25__throw_bad_function_callv, 264)
PLAT_STUB(_ZdaPv, 265)
PLAT_STUB(_ZdlPv, 266)
PLAT_STUB(__aeabi_atexit, 267)
PLAT_STUB(__aeabi_cdcmpeq, 268)
PLAT_STUB(__aeabi_cdcmple, 269)
PLAT_STUB(__aeabi_cdrcmple, 270)
PLAT_STUB(__aeabi_d2f, 271)
PLAT_STUB(__aeabi_d2iz, 272)
PLAT_STUB(__aeabi_d2lz, 273)
PLAT_STUB(__aeabi_d2uiz, 274)
PLAT_STUB(__aeabi_d2ulz, 275)
PLAT_STUB(__aeabi_dadd, 276)
PLAT_STUB(__aeabi_dcmpeq, 277)
PLAT_STUB(__aeabi_dcmpge, 278)
PLAT_STUB(__aeabi_dcmpgt, 279)
PLAT_STUB(__aeabi_dcmple, 280)
PLAT_STUB(__aeabi_dcmplt, 281)
PLAT_STUB(__aeabi_dcmpun, 282)
PLAT_STUB(__aeabi_ddiv, 283)
PLAT_STUB(__aeabi_dmul, 284)
PLAT_STUB(__aeabi_drsub, 285)
PLAT_STUB(__aeabi_dsub, 286)
PLAT_STUB(__aeabi_f2d, 287)
PLAT_STUB(__aeabi_i2d, 288)
PLAT_STUB(__aeabi_l2d, 289)
PLAT_STUB(__aeabi_ldivmod, 290)
PLAT_STUB(__aeabi_ui2d, 291)
PLAT_STUB(__aeabi_ul2d, 292)
PLAT_STUB(__aeabi_uldivmod, 293)
PLAT_STUB(__assert_func, 294)
PLAT_STUB(__cxa_thread_atexit, 295)
PLAT_STUB(__emutls_get_address, 296)
PLAT_STUB(__popcountdi2, 297)
PLAT_STUB(__popcountsi2, 298)
PLAT_STUB(__wrap_time, 299)
PLAT_STUB(abort, 300)
PLAT_STUB(acos, 301)
PLAT_STUB(aligned_alloc, 302)
PLAT_STUB(apmuSetDeepestSleepMode, 303)
PLAT_STUB(appGetECBCInfoSync, 304)
PLAT_STUB(appSetCFUN, 305)
PLAT_STUB(asin, 306)
PLAT_STUB(atan, 307)
PLAT_STUB(atan2, 308)
PLAT_STUB(calloc, 309)
PLAT_STUB(ceil, 310)
PLAT_STUB(cos, 311)
PLAT_STUB(cosh, 312)
PLAT_STUB(delay_us, 313)
PLAT_STUB(deregisterPSEventCallback, 314)
PLAT_STUB(exp, 315)
PLAT_STUB(fabs, 316)
PLAT_STUB(fclose, 317)
PLAT_STUB(feof, 318)
PLAT_STUB(fflush, 319)
PLAT_STUB(floor, 320)
PLAT_STUB(fmod, 321)
PLAT_STUB(fopen, 322)
PLAT_STUB(fotaNvmNfsPeInit, 323)
PLAT_STUB(fputc, 324)
PLAT_STUB(fputs, 325)
PLAT_STUB(fread, 326)
PLAT_STUB(free, 327)
PLAT_STUB(fseek, 328)
PLAT_STUB(fwrite, 329)
PLAT_STUB(gmtime_r, 330)
PLAT_STUB(gpio_set_pad_wakeup_callback, 331)
PLAT_STUB(isspace, 332)
PLAT_STUB(localtime_r, 333)
PLAT_STUB(log, 334)
PLAT_STUB(luat_mobile_config, 335)
PLAT_STUB(luat_rtos_task_create, 336)
PLAT_STUB(luat_rtos_task_sleep, 337)
PLAT_STUB(luat_uart_exist, 338)
PLAT_STUB(luat_uart_write, 339)
PLAT_STUB(malloc, 340)
PLAT_STUB(memchr, 341)
PLAT_STUB(memcmp, 342)
PLAT_STUB(memcpy, 343)
PLAT_STUB(memmove, 344)
PLAT_STUB(memset, 345)
PLAT_STUB(mktime, 346)
PLAT_STUB(osDelay, 347)
PLAT_STUB(osKernelGetTickCount, 348)
PLAT_STUB(pbuf_alloc, 349)
PLAT_STUB(pbuf_cat, 350)
PLAT_STUB(pbuf_free, 351)
PLAT_STUB(pbuf_ref, 352)
PLAT_STUB(pow, 353)
PLAT_STUB(printf, 354)
PLAT_STUB(psSetCdgcont, 355)
PLAT_STUB(putchar, 356)
PLAT_STUB(putenv, 357)
PLAT_STUB(puts, 358)
PLAT_STUB(pwrKeyIntHandler, 359)
PLAT_STUB(rand, 360)
PLAT_STUB(realloc, 361)
PLAT_STUB(registerPSEventCallback, 362)
PLAT_STUB(rngGenRandom, 363)
PLAT_STUB(round, 364)
PLAT_STUB(sin, 365)
PLAT_STUB(sinh, 366)
PLAT_STUB(slot_marker_read, 367)
PLAT_STUB(slot_marker_write, 368)
PLAT_STUB(slpManAONIOLatchEn, 369)
PLAT_STUB(slpManAONIOPowerOff, 370)
PLAT_STUB(slpManAONIOPowerOn, 371)
PLAT_STUB(slpManAONIOVoltGet, 372)
PLAT_STUB(slpManAONIOVoltSet, 373)
PLAT_STUB(slpManAonWdtFeed, 374)
PLAT_STUB(slpManAonWdtStop, 375)
PLAT_STUB(slpManApplyPlatVoteHandle, 376)
PLAT_STUB(slpManDeepSlpTimerDel, 377)
PLAT_STUB(slpManDeepSlpTimerRegisterExpCb, 378)
PLAT_STUB(slpManDeepSlpTimerStart, 379)
PLAT_STUB(slpManDrvVoteSleep, 380)
PLAT_STUB(slpManExcutePredefinedBackupCb, 381)
PLAT_STUB(slpManExcutePredefinedBackupCbInPaging, 382)
PLAT_STUB(slpManExcutePredefinedRestoreCb, 383)
PLAT_STUB(slpManExcutePredefinedRestoreCbInPaging, 384)
PLAT_STUB(slpManExcuteUsrdefinedBackupCb, 385)
PLAT_STUB(slpManExcuteUsrdefinedRestoreCb, 386)
PLAT_STUB(slpManExtIntPreProcess, 387)
PLAT_STUB(slpManGetDrvBitmap, 388)
PLAT_STUB(slpManGetDrvVoteMask, 389)
PLAT_STUB(slpManGetLastSlpState, 390)
PLAT_STUB(slpManGetWakeupPadCfg, 391)
PLAT_STUB(slpManGetWakeupPinValue, 392)
PLAT_STUB(slpManGivebackPlatVoteHandle, 393)
PLAT_STUB(slpManPlatGetSlpState, 394)
PLAT_STUB(slpManPlatVoteDisableSleep, 395)
PLAT_STUB(slpManPlatVoteEnableSleep, 396)
PLAT_STUB(slpManProductionTest, 397)
PLAT_STUB(slpManRegisterPredefinedBackupCb, 398)
PLAT_STUB(slpManRegisterPredefinedRestoreCb, 399)
PLAT_STUB(slpManSetDrvVoteMask, 400)
PLAT_STUB(slpManSetPmuSleepMode, 401)
PLAT_STUB(slpManSetWakeupPadCfg, 402)
PLAT_STUB(slpManStartPowerOff, 403)
PLAT_STUB(slpManUnregisterPredefinedBackupCb, 404)
PLAT_STUB(slpManUnregisterPredefinedRestoreCb, 405)
PLAT_STUB(slpManUpdatePmuTimingCfg, 406)
PLAT_STUB(snprintf, 407)
PLAT_STUB(soc_call_function_in_service, 408)
PLAT_STUB(soc_cms_proc, 409)
PLAT_STUB(soc_disable_tcpip_use_default_pdp, 410)
PLAT_STUB(soc_fast_printf, 411)
PLAT_STUB(soc_free_later, 412)
PLAT_STUB(soc_get_poweron_time_ms, 413)
PLAT_STUB(soc_get_poweron_time_tick, 414)
PLAT_STUB(soc_info, 415)
PLAT_STUB(soc_mobile_default_pdn_ip_type, 416)
PLAT_STUB(soc_mobile_search_cell_info_async, 417)
PLAT_STUB(soc_mobile_set_rrc_release_time, 418)
PLAT_STUB(soc_netif_input_prepare, 419)
PLAT_STUB(soc_power_mode, 420)
PLAT_STUB(soc_printf, 421)
PLAT_STUB(soc_set_usb_sleep, 422)
PLAT_STUB(soc_uart0_set_log_off, 423)
PLAT_STUB(soc_unilog_callback, 424)
PLAT_STUB(soc_usb_onoff, 425)
PLAT_STUB(soc_usb_serial_output, 426)
PLAT_STUB(soc_vsprintf, 427)
PLAT_STUB(sprintf, 428)
PLAT_STUB(sqrt, 429)
PLAT_STUB(srand, 430)
PLAT_STUB(sscanf, 431)
PLAT_STUB(strcat, 432)
PLAT_STUB(strchr, 433)
PLAT_STUB(strcmp, 434)
PLAT_STUB(strcpy, 435)
PLAT_STUB(strcspn, 436)
PLAT_STUB(strdup, 437)
PLAT_STUB(strerror, 438)
PLAT_STUB(strlen, 439)
PLAT_STUB(strncat, 440)
PLAT_STUB(strncmp, 441)
PLAT_STUB(strncpy, 442)
PLAT_STUB(strnlen, 443)
PLAT_STUB(strspn, 444)
PLAT_STUB(strstr, 445)
PLAT_STUB(strtod, 446)
PLAT_STUB(strtoul, 447)
PLAT_STUB(tan, 448)
PLAT_STUB(tanh, 449)
PLAT_STUB(tcp_accept, 450)
PLAT_STUB(tcp_arg, 451)
PLAT_STUB(tcp_bind, 452)
PLAT_STUB(tcp_close, 453)
PLAT_STUB(tcp_connect, 454)
PLAT_STUB(tcp_err, 455)
PLAT_STUB(tcp_listen_with_backlog, 456)
PLAT_STUB(tcp_new, 457)
PLAT_STUB(tcp_output, 458)
PLAT_STUB(tcp_recv, 459)
PLAT_STUB(tcp_recved, 460)
PLAT_STUB(tcp_sent, 461)
PLAT_STUB(tcp_shutdown, 462)
PLAT_STUB(tcp_write, 463)
PLAT_STUB(tcpip_callback_with_block, 464)
PLAT_STUB(trimAdcSetGolbalVar, 465)
PLAT_STUB(trunc, 466)
PLAT_STUB(tzset, 467)
PLAT_STUB(udp_bind, 468)
PLAT_STUB(udp_connect, 469)
PLAT_STUB(udp_new, 470)
PLAT_STUB(udp_recv, 471)
PLAT_STUB(udp_remove, 472)
PLAT_STUB(udp_send, 473)
PLAT_STUB(udp_sendto, 474)
PLAT_STUB(vPortGetHeapStats, 475)
PLAT_STUB(vPortGetHeapTag, 476)
PLAT_STUB(vPortIterateAllocations, 477)
PLAT_STUB(vPortSetHeapTag, 478)
PLAT_STUB(vQueueDelete, 479)
PLAT_STUB(vTaskDelete, 480)
PLAT_STUB(vfprintf, 481)
PLAT_STUB(vsnprintf, 482)
PLAT_STUB(xQueueCreateMutex, 483)
PLAT_STUB(xQueueGenericCreate, 484)
PLAT_STUB(xQueueGenericReceive, 485)
PLAT_STUB(xQueueGenericSend, 486)
PLAT_STUB(xQueueGenericSendFromISR, 487)
PLAT_STUB(xQueueGetMutexHolder, 488)
PLAT_STUB(xTaskCreate, 489)
PLAT_STUB(xTaskGenericNotify, 490)
PLAT_STUB(xTaskGetCurrentTaskHandle, 491)
PLAT_STUB(xTaskNotifyWait, 492)
