...
PLAT_STUB(slpManGivebackPlatVoteHandle, 382)
PLAT_STUB(slpManPlatGetSlpState, 383)
PLAT_STUB(slpManPlatVoteDisableSleep, 384)
PLAT_STUB(slpManPlatVoteEnableSleep, 385)
PLAT_STUB(slpManProductionTest, 386)
PLAT_STUB(slpManRegisterPredefinedBackupCb, 387)
PLAT_STUB(slpManRegisterPredefinedRestoreCb, 388)
PLAT_STUB(slpManSetDrvVoteMask, 389)
PLAT_STUB(slpManSetPmuSleepMode, 390)
PLAT_STUB(slpManSetWakeupPadCfg, 391)
PLAT_STUB(slpManStartPowerOff, 392)
PLAT_STUB(slpManUnregisterPredefinedBackupCb, 393)
PLAT_STUB(slpManUnregisterPredefinedRestoreCb, 394)
PLAT_STUB(slpManUpdatePmuTimingCfg, 395)
PLAT_STUB(snprintf, 396)
PLAT_STUB(soc_call_function_in_service, 397)
PLAT_STUB(soc_cms_proc, 398)
PLAT_STUB(soc_disable_tcpip_use_default_pdp, 399)
PLAT_STUB(soc_fast_printf, 400)
PLAT_STUB(soc_free_later, 401)
PLAT_STUB(soc_get_poweron_time_ms, 402)
PLAT_STUB(soc_get_poweron_time_tick, 403)
PLAT_STUB(soc_info, 404)
PLAT_STUB(soc_mobile_default_pdn_ip_type, 405)
PLAT_STUB(soc_mobile_search_cell_info_async, 406)
PLAT_STUB(soc_mobile_set_rrc_release_time, 407)
PLAT_STUB(soc_netif_input_prepare, 408)
PLAT_STUB(soc_power_mode, 409)
PLAT_STUB(soc_printf, 410)
PLAT_STUB(soc_set_usb_sleep, 411)
PLAT_STUB(soc_uart0_set_log_off, 412)
PLAT_STUB(soc_unilog_callback, 413)
PLAT_STUB(soc_usb_onoff, 414)
PLAT_STUB(soc_usb_serial_output, 415)
PLAT_STUB(soc_vsprintf, 416)
PLAT_STUB(sprintf, 417)
PLAT_STUB(sqrt, 418)
PLAT_STUB(srand, 419)
PLAT_STUB(sscanf, 420)
PLAT_STUB(strcat, 421)
PLAT_STUB(strchr, 422)
PLAT_STUB(strcmp, 423)
PLAT_STUB(strcpy, 424)
PLAT_STUB(strcspn, 425)
PLAT_STUB(strdup, 426)
PLAT_STUB(strerror, 427)
PLAT_STUB(strlen, 428)
PLAT_STUB(strncat, 429)
PLAT_STUB(strncmp, 430)
PLAT_STUB(strncpy, 431)
PLAT_STUB(strnlen, 432)
PLAT_STUB(strspn, 433)
PLAT_STUB(strstr, 434)
PLAT_STUB(strtod, 435)
PLAT_STUB(strtoul, 436)
PLAT_STUB(tan, 437)
PLAT_STUB(tanh, 438)
PLAT_STUB(tcp_accept, 439)
PLAT_STUB(tcp_arg, 440)
PLAT_STUB(tcp_bind, 441)
PLAT_STUB(tcp_close, 442)
PLAT_STUB(tcp_connect, 443)
PLAT_STUB(tcp_err, 444)
PLAT_STUB(tcp_listen_with_backlog, 445)
PLAT_STUB(tcp_new, 446)
PLAT_STUB(tcp_output, 447)
PLAT_STUB(tcp_recv, 448)
PLAT_STUB(tcp_recved, 449)
PLAT_STUB(tcp_sent, 450)
PLAT_STUB(tcp_shutdown, 451)
PLAT_STUB(tcp_write, 452)
PLAT_STUB(tcpip_callback_with_block, 453)
PLAT_STUB(trimAdcSetGolbalVar, 454)
PLAT_STUB(trunc, 455)
PLAT_STUB(tzset, 456)
PLAT_STUB(udp_bind, 457)
PLAT_STUB(udp_connect, 458)
PLAT_STUB(udp_new, 459)
PLAT_STUB(udp_recv, 460)
PLAT_STUB(udp_remove, 461)
PLAT_STUB(udp_send, 462)
PLAT_STUB(udp_sendto, 463)
PLAT_STUB(vPortGetHeapStats, 464)
PLAT_STUB(vPortGetHeapTag, 465)
PLAT_STUB(vPortIterateAllocations, 466)
PLAT_STUB(vPortSetHeapTag, 467)
PLAT_STUB(vQueueDelete, 468)
PLAT_STUB(vTaskDelete, 469)
PLAT_STUB(vfprintf, 470)
PLAT_STUB(vsnprintf, 471)
PLAT_STUB(xQueueCreateMutex, 472)
PLAT_STUB(xQueueGenericCreate, 473)
PLAT_STUB(xQueueGenericReceive, 474)
PLAT_STUB(xQueueGenericSend, 475)
PLAT_STUB(xQueueGenericSendFromISR, 476)
PLAT_STUB(xQueueGetMutexHolder, 477)
PLAT_STUB(xTaskCreate, 478)
PLAT_STUB(xTaskGenericNotify, 479)
PLAT_STUB(xTaskGetCurrentTaskHandle, 480)
PLAT_STUB(xTaskNotifyWait, 481)
