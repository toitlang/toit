...
PLAT_STUB(GPIO_ExtiConfig, 70)
PLAT_STUB(GPIO_ExtiSetCB, 71)
PLAT_STUB(GPIO_FastOutput, 72)
PLAT_STUB(GPIO_GlobalInit, 73)
PLAT_STUB(GPIO_Input, 74)
PLAT_STUB(GPIO_InputMulti, 75)
PLAT_STUB(GPIO_IomuxEC618, 76)
PLAT_STUB(GPIO_OutPulse, 77)
PLAT_STUB(GPIO_Output, 78)
PLAT_STUB(GPIO_OutputMulti, 79)
PLAT_STUB(GPIO_PullConfig, 80)
PLAT_STUB(GPIO_ToPadEC618, 81)
PLAT_STUB(GPIO_Toggle, 82)
PLAT_STUB(GPIO_ToggleMulti, 83)
PLAT_STUB(GPIO_WakeupPadConfig, 84)
PLAT_STUB(GPIO_clearInterruptFlags, 85)
PLAT_STUB(GPIO_driverInit, 86)
PLAT_STUB(GPIO_enterLowPowerStatePrepare, 87)
PLAT_STUB(GPIO_exitLowPowerStateRestore, 88)
PLAT_STUB(GPIO_getInterruptFlags, 89)
PLAT_STUB(GPIO_interruptConfig, 90)
PLAT_STUB(GPIO_pinConfig, 91)
PLAT_STUB(GPIO_pinRead, 92)
PLAT_STUB(GPIO_pinWrite, 93)
PLAT_STUB(GPR_Is51MClockInUse, 94)
PLAT_STUB(GPR_USBCHRST_ResetReq_SetVal, 95)
PLAT_STUB(GPR_USBCPhy_ResetReq_SetVal, 96)
PLAT_STUB(GPR_USBPAPB_ResetReq_SetVal, 97)
PLAT_STUB(GPR_USBPPor_ResetReq_SetVal, 98)
PLAT_STUB(GPR_USBPUtmi_ResetReq_SetVal, 99)
PLAT_STUB(GPR_USB_DM_Ctrl_Disable_Rst, 100)
PLAT_STUB(GPR_USB_DM_Ctrl_Enable_Without_Usbcprst, 101)
PLAT_STUB(GPR_apAccessEnter, 102)
PLAT_STUB(GPR_apAccessExit, 103)
PLAT_STUB(GPR_apDFCVote4CP, 104)
PLAT_STUB(GPR_apDFCVoteIdle, 105)
PLAT_STUB(GPR_apSysClkForceOnControl, 106)
PLAT_STUB(GPR_bootSetting, 107)
PLAT_STUB(GPR_clockDisable, 108)
PLAT_STUB(GPR_clockEnable, 109)
PLAT_STUB(GPR_clockEnableCheck, 110)
PLAT_STUB(GPR_cpGetRstSrc, 111)
PLAT_STUB(GPR_cpResetCfgSet, 112)
PLAT_STUB(GPR_csmbAccessEnter, 113)
PLAT_STUB(GPR_csmbAccessExit, 114)
PLAT_STUB(GPR_flashClockDisable, 115)
PLAT_STUB(GPR_flashClockEnable, 116)
PLAT_STUB(GPR_flashSWReset, 117)
PLAT_STUB(GPR_getClockFreq, 118)
PLAT_STUB(GPR_getSystickClk, 119)
PLAT_STUB(GPR_initialize, 120)
PLAT_STUB(GPR_lockUpActionCtrl, 121)
PLAT_STUB(GPR_rmiHrstRel, 122)
PLAT_STUB(GPR_setApbGprAcg, 123)
PLAT_STUB(GPR_setClockDiv, 124)
PLAT_STUB(GPR_setClockSrc, 125)
PLAT_STUB(GPR_setFlashClockDiv, 126)
PLAT_STUB(GPR_setFlashClockSrc, 127)
PLAT_STUB(GPR_swReset, 128)
PLAT_STUB(GPR_swResetModule, 129)
PLAT_STUB(GPR_switchSystickClk, 130)
PLAT_STUB(GPR_unilogSWReset, 131)
PLAT_STUB(GPR_usbUlgClr, 132)
PLAT_STUB(GPR_usbUlgSet, 133)
PLAT_STUB(HAL_ADC_CalibrateRawCode, 134)
PLAT_STUB(HAL_ADC_ConvertThermalRawCodeToTemperatureHighAccuracy, 135)
PLAT_STUB(HAL_QSPI_Command, 136)
PLAT_STUB(HAL_QSPI_Config, 137)
PLAT_STUB(HAL_QSPI_Init, 138)
PLAT_STUB(HAL_QSPI_Receive, 139)
PLAT_STUB(HAL_QSPI_Set_CPflh_Clk, 140)
PLAT_STUB(HAL_QSPI_Set_Clk, 141)
PLAT_STUB(HAL_QSPI_Transmit, 142)
PLAT_STUB(HAL_QSPI_XIP_Enable, 143)
PLAT_STUB(HAL_UartDumpPortCheck, 144)
PLAT_STUB(HAL_UartDumpPortInit, 145)
PLAT_STUB(HAL_UartDumpPortSend, 146)
PLAT_STUB(I2C_BlockRead, 147)
PLAT_STUB(I2C_BlockWrite, 148)
PLAT_STUB(I2C_ChangeBR, 149)
PLAT_STUB(I2C_Control, 150)
PLAT_STUB(I2C_GetCapabilities, 151)
PLAT_STUB(I2C_GetClockFreq, 152)
PLAT_STUB(I2C_GetDataCount, 153)
PLAT_STUB(I2C_GetStatus, 154)
PLAT_STUB(I2C_Initialize, 155)
PLAT_STUB(I2C_MasterReceive, 156)
PLAT_STUB(I2C_MasterSetup, 157)
PLAT_STUB(I2C_MasterTransmit, 158)
PLAT_STUB(I2C_MasterXfer, 159)
PLAT_STUB(I2C_PowerControl, 160)
PLAT_STUB(I2C_Prepare, 161)
PLAT_STUB(I2C_Reset, 162)
PLAT_STUB(I2C_SetNoBlock, 163)
PLAT_STUB(I2C_SlaveReceive, 164)
PLAT_STUB(I2C_Uninitialize, 165)
PLAT_STUB(I2C_UsePollingMode, 166)
PLAT_STUB(I2C_WaitResult, 167)
PLAT_STUB(OsaSystemTimeReadRamUtc, 168)
PLAT_STUB(OsaTimerSync, 169)
PLAT_STUB(PAD_driverInit, 170)
PLAT_STUB(PAD_enterLowPowerStatePrepare, 171)
PLAT_STUB(PAD_exitLowPowerStateRestore, 172)
PLAT_STUB(PAD_getDefaultConfig, 173)
PLAT_STUB(PAD_setPinConfig, 174)
PLAT_STUB(PAD_setPinPullConfig, 175)
PLAT_STUB(Pad0_WakeupIntHandler, 176)
PLAT_STUB(Pad1_WakeupIntHandler, 177)
PLAT_STUB(Pad2_WakeupIntHandler, 178)
PLAT_STUB(Pad3_WakeupIntHandler, 179)
PLAT_STUB(Pad4_WakeupIntHandler, 180)
PLAT_STUB(Pad5_WakeupIntHandler, 181)
PLAT_STUB(QSPI_CheckQEnFlag, 182)
PLAT_STUB(QSPI_PollingBusyFlagIntableOnce, 183)
PLAT_STUB(RTC_WakeupIntHandler, 184)
PLAT_STUB(ResetStateGet, 185)
PLAT_STUB(TIMER_clearInterruptFlags, 186)
PLAT_STUB(TIMER_deInit, 187)
PLAT_STUB(TIMER_driverInit, 188)
PLAT_STUB(TIMER_getDefaultConfig, 189)
PLAT_STUB(TIMER_getInterruptFlags, 190)
PLAT_STUB(TIMER_init, 191)
PLAT_STUB(TIMER_interruptConfig, 192)
PLAT_STUB(TIMER_start, 193)
PLAT_STUB(TIMER_stop, 194)
PLAT_STUB(UART_flush, 195)
PLAT_STUB(UART_init, 196)
PLAT_STUB(UART_receive, 197)
PLAT_STUB(UART_send, 198)
PLAT_STUB(UART_setBaudrate, 199)
PLAT_STUB(USART0_IRQHandler, 200)
PLAT_STUB(USART1_DmaRxEvent, 201)
PLAT_STUB(USART1_DmaTxEvent, 202)
PLAT_STUB(USART1_IRQHandler, 203)
PLAT_STUB(USART2_DmaRxEvent, 204)
PLAT_STUB(USART2_IRQHandler, 205)
PLAT_STUB(USART_Control, 206)
PLAT_STUB(USART_DmaRxEvent, 207)
PLAT_STUB(USART_DmaTxEvent, 208)
PLAT_STUB(USART_GetBaudRate, 209)
PLAT_STUB(USART_GetCapabilities, 210)
PLAT_STUB(USART_GetModemStatus, 211)
PLAT_STUB(USART_GetRxCount, 212)
PLAT_STUB(USART_GetStatus, 213)
PLAT_STUB(USART_GetTxCount, 214)
PLAT_STUB(USART_IRQHandler, 215)
PLAT_STUB(USART_Initialize, 216)
PLAT_STUB(USART_PowerControl, 217)
PLAT_STUB(USART_Receive, 218)
PLAT_STUB(USART_Send, 219)
PLAT_STUB(USART_SendPolling, 220)
PLAT_STUB(USART_SetBaudrate, 221)
PLAT_STUB(USART_SetModemControl, 222)
PLAT_STUB(USART_Uninitialize, 223)
PLAT_STUB(Uart_BaseInitEx, 224)
PLAT_STUB(Uart_ChangeBR, 225)
PLAT_STUB(Uart_DeInit, 226)
PLAT_STUB(Uart_IsTSREmpty, 227)
PLAT_STUB(Uart_RxBufferClear, 228)
PLAT_STUB(Uart_RxBufferRead, 229)
PLAT_STUB(Uart_TxTaskSafe, 230)
PLAT_STUB(WDT_deInit, 231)
PLAT_STUB(WDT_getStartStatus, 232)
PLAT_STUB(WDT_init, 233)
PLAT_STUB(WDT_kick, 234)
PLAT_STUB(WDT_start, 235)
PLAT_STUB(WDT_stop, 236)
PLAT_STUB(WDT_unlock, 237)
PLAT_STUB(XIC_EnableIRQ, 238)
PLAT_STUB(XIC_SetVector, 239)
PLAT_STUB(_ZNSt13random_device7_M_finiEv, 240)
PLAT_STUB(_ZNSt13random_device7_M_initERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE, 241)
PLAT_STUB(_ZNSt13random_device9_M_getvalEv, 242)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv, 243)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_S_copy_charsEPcPKcS7_, 244)
PLAT_STUB(_ZSt25__throw_bad_function_callv, 245)
PLAT_STUB(_ZdaPv, 246)
PLAT_STUB(_ZdlPv, 247)
PLAT_STUB(__aeabi_atexit, 248)
PLAT_STUB(__aeabi_cdcmpeq, 249)
PLAT_STUB(__aeabi_cdcmple, 250)
PLAT_STUB(__aeabi_cdrcmple, 251)
PLAT_STUB(__aeabi_d2f, 252)
PLAT_STUB(__aeabi_d2iz, 253)
PLAT_STUB(__aeabi_d2lz, 254)
PLAT_STUB(__aeabi_d2uiz, 255)
PLAT_STUB(__aeabi_d2ulz, 256)
PLAT_STUB(__aeabi_dadd, 257)
PLAT_STUB(__aeabi_dcmpeq, 258)
PLAT_STUB(__aeabi_dcmpge, 259)
PLAT_STUB(__aeabi_dcmpgt, 260)
PLAT_STUB(__aeabi_dcmple, 261)
PLAT_STUB(__aeabi_dcmplt, 262)
PLAT_STUB(__aeabi_dcmpun, 263)
PLAT_STUB(__aeabi_ddiv, 264)
PLAT_STUB(__aeabi_dmul, 265)
PLAT_STUB(__aeabi_drsub, 266)
PLAT_STUB(__aeabi_dsub, 267)
PLAT_STUB(__aeabi_f2d, 268)
PLAT_STUB(__aeabi_i2d, 269)
PLAT_STUB(__aeabi_l2d, 270)
PLAT_STUB(__aeabi_ldivmod, 271)
PLAT_STUB(__aeabi_ui2d, 272)
PLAT_STUB(__aeabi_ul2d, 273)
PLAT_STUB(__aeabi_uldivmod, 274)
PLAT_STUB(__assert_func, 275)
PLAT_STUB(__cxa_thread_atexit, 276)
PLAT_STUB(__emutls_get_address, 277)
PLAT_STUB(__popcountdi2, 278)
PLAT_STUB(__popcountsi2, 279)
PLAT_STUB(__wrap_time, 280)
PLAT_STUB(abort, 281)
PLAT_STUB(acos, 282)
PLAT_STUB(aligned_alloc, 283)
PLAT_STUB(apmuSetDeepestSleepMode, 284)
PLAT_STUB(appGetECBCInfoSync, 285)
PLAT_STUB(appSetCFUN, 286)
PLAT_STUB(asin, 287)
PLAT_STUB(atan, 288)
PLAT_STUB(atan2, 289)
PLAT_STUB(calloc, 290)
PLAT_STUB(ceil, 291)
PLAT_STUB(cos, 292)
PLAT_STUB(cosh, 293)
PLAT_STUB(delay_us, 294)
PLAT_STUB(deregisterPSEventCallback, 295)
PLAT_STUB(exp, 296)
PLAT_STUB(fabs, 297)
PLAT_STUB(fclose, 298)
PLAT_STUB(feof, 299)
PLAT_STUB(fflush, 300)
PLAT_STUB(floor, 301)
PLAT_STUB(fmod, 302)
PLAT_STUB(fopen, 303)
PLAT_STUB(fotaNvmNfsPeInit, 304)
PLAT_STUB(fputc, 305)
PLAT_STUB(fputs, 306)
PLAT_STUB(fread, 307)
PLAT_STUB(free, 308)
PLAT_STUB(fseek, 309)
PLAT_STUB(fwrite, 310)
PLAT_STUB(gmtime_r, 311)
PLAT_STUB(isspace, 312)
PLAT_STUB(localtime_r, 313)
PLAT_STUB(log, 314)
PLAT_STUB(luat_mobile_config, 315)
PLAT_STUB(luat_rtos_task_create, 316)
PLAT_STUB(luat_rtos_task_sleep, 317)
PLAT_STUB(luat_uart_exist, 318)
PLAT_STUB(luat_uart_write, 319)
PLAT_STUB(malloc, 320)
PLAT_STUB(memchr, 321)
PLAT_STUB(memcmp, 322)
PLAT_STUB(memcpy, 323)
PLAT_STUB(memmove, 324)
PLAT_STUB(memset, 325)
PLAT_STUB(mktime, 326)
PLAT_STUB(osDelay, 327)
PLAT_STUB(osKernelGetTickCount, 328)
PLAT_STUB(pbuf_alloc, 329)
PLAT_STUB(pbuf_cat, 330)
PLAT_STUB(pbuf_free, 331)
PLAT_STUB(pbuf_ref, 332)
PLAT_STUB(pow, 333)
PLAT_STUB(printf, 334)
PLAT_STUB(psSetCdgcont, 335)
PLAT_STUB(putchar, 336)
PLAT_STUB(putenv, 337)
PLAT_STUB(puts, 338)
PLAT_STUB(pwrKeyIntHandler, 339)
PLAT_STUB(rand, 340)
PLAT_STUB(realloc, 341)
PLAT_STUB(registerPSEventCallback, 342)
PLAT_STUB(rngGenRandom, 343)
PLAT_STUB(round, 344)
PLAT_STUB(sin, 345)
PLAT_STUB(sinh, 346)
PLAT_STUB(slot_marker_read, 347)
PLAT_STUB(slot_marker_write, 348)
PLAT_STUB(slpManAonWdtFeed, 349)
PLAT_STUB(slpManAonWdtStop, 350)
PLAT_STUB(slpManApplyPlatVoteHandle, 351)
PLAT_STUB(slpManDeepSlpTimerDel, 352)
PLAT_STUB(slpManDeepSlpTimerRegisterExpCb, 353)
PLAT_STUB(slpManDeepSlpTimerStart, 354)
PLAT_STUB(slpManDrvVoteSleep, 355)
PLAT_STUB(slpManExcutePredefinedBackupCb, 356)
PLAT_STUB(slpManExcutePredefinedBackupCbInPaging, 357)
PLAT_STUB(slpManExcutePredefinedRestoreCb, 358)
PLAT_STUB(slpManExcutePredefinedRestoreCbInPaging, 359)
PLAT_STUB(slpManExcuteUsrdefinedBackupCb, 360)
PLAT_STUB(slpManExcuteUsrdefinedRestoreCb, 361)
PLAT_STUB(slpManExtIntPreProcess, 362)
PLAT_STUB(slpManGetDrvBitmap, 363)
PLAT_STUB(slpManGetDrvVoteMask, 364)
PLAT_STUB(slpManGetLastSlpState, 365)
PLAT_STUB(slpManGetWakeupPadCfg, 366)
PLAT_STUB(slpManGetWakeupPinValue, 367)
PLAT_STUB(slpManGivebackPlatVoteHandle, 368)
PLAT_STUB(slpManPlatGetSlpState, 369)
PLAT_STUB(slpManPlatVoteDisableSleep, 370)
PLAT_STUB(slpManPlatVoteEnableSleep, 371)
PLAT_STUB(slpManProductionTest, 372)
PLAT_STUB(slpManRegisterPredefinedBackupCb, 373)
PLAT_STUB(slpManRegisterPredefinedRestoreCb, 374)
PLAT_STUB(slpManSetDrvVoteMask, 375)
PLAT_STUB(slpManSetPmuSleepMode, 376)
PLAT_STUB(slpManSetWakeupPadCfg, 377)
PLAT_STUB(slpManStartPowerOff, 378)
PLAT_STUB(slpManUnregisterPredefinedBackupCb, 379)
PLAT_STUB(slpManUnregisterPredefinedRestoreCb, 380)
PLAT_STUB(slpManUpdatePmuTimingCfg, 381)
PLAT_STUB(snprintf, 382)
PLAT_STUB(soc_call_function_in_service, 383)
PLAT_STUB(soc_cms_proc, 384)
PLAT_STUB(soc_disable_tcpip_use_default_pdp, 385)
PLAT_STUB(soc_free_later, 386)
PLAT_STUB(soc_get_poweron_time_ms, 387)
PLAT_STUB(soc_get_poweron_time_tick, 388)
PLAT_STUB(soc_info, 389)
PLAT_STUB(soc_mobile_default_pdn_ip_type, 390)
PLAT_STUB(soc_mobile_search_cell_info_async, 391)
PLAT_STUB(soc_mobile_set_rrc_release_time, 392)
PLAT_STUB(soc_netif_input_prepare, 393)
PLAT_STUB(soc_power_mode, 394)
PLAT_STUB(soc_printf, 395)
PLAT_STUB(soc_set_usb_sleep, 396)
PLAT_STUB(soc_uart0_set_log_off, 397)
PLAT_STUB(soc_unilog_callback, 398)
PLAT_STUB(soc_usb_onoff, 399)
PLAT_STUB(soc_usb_serial_output, 400)
PLAT_STUB(soc_vsprintf, 401)
PLAT_STUB(sprintf, 402)
PLAT_STUB(sqrt, 403)
PLAT_STUB(srand, 404)
PLAT_STUB(sscanf, 405)
PLAT_STUB(strcat, 406)
PLAT_STUB(strchr, 407)
PLAT_STUB(strcmp, 408)
PLAT_STUB(strcpy, 409)
PLAT_STUB(strcspn, 410)
PLAT_STUB(strdup, 411)
PLAT_STUB(strerror, 412)
PLAT_STUB(strlen, 413)
PLAT_STUB(strncat, 414)
PLAT_STUB(strncmp, 415)
PLAT_STUB(strncpy, 416)
PLAT_STUB(strnlen, 417)
PLAT_STUB(strspn, 418)
PLAT_STUB(strstr, 419)
PLAT_STUB(strtod, 420)
PLAT_STUB(strtoul, 421)
PLAT_STUB(tan, 422)
PLAT_STUB(tanh, 423)
PLAT_STUB(tcp_accept, 424)
PLAT_STUB(tcp_arg, 425)
PLAT_STUB(tcp_bind, 426)
PLAT_STUB(tcp_close, 427)
PLAT_STUB(tcp_connect, 428)
PLAT_STUB(tcp_err, 429)
PLAT_STUB(tcp_listen_with_backlog, 430)
PLAT_STUB(tcp_new, 431)
PLAT_STUB(tcp_output, 432)
PLAT_STUB(tcp_recv, 433)
PLAT_STUB(tcp_recved, 434)
PLAT_STUB(tcp_sent, 435)
PLAT_STUB(tcp_shutdown, 436)
PLAT_STUB(tcp_write, 437)
PLAT_STUB(tcpip_callback_with_block, 438)
PLAT_STUB(trimAdcSetGolbalVar, 439)
PLAT_STUB(trunc, 440)
PLAT_STUB(tzset, 441)
PLAT_STUB(udp_bind, 442)
PLAT_STUB(udp_connect, 443)
PLAT_STUB(udp_new, 444)
PLAT_STUB(udp_recv, 445)
PLAT_STUB(udp_remove, 446)
PLAT_STUB(udp_send, 447)
PLAT_STUB(udp_sendto, 448)
PLAT_STUB(vPortGetHeapStats, 449)
PLAT_STUB(vPortGetHeapTag, 450)
PLAT_STUB(vPortIterateAllocations, 451)
PLAT_STUB(vPortSetHeapTag, 452)
PLAT_STUB(vQueueDelete, 453)
PLAT_STUB(vTaskDelete, 454)
PLAT_STUB(vfprintf, 455)
PLAT_STUB(vsnprintf, 456)
PLAT_STUB(xQueueCreateMutex, 457)
PLAT_STUB(xQueueGenericCreate, 458)
PLAT_STUB(xQueueGenericReceive, 459)
PLAT_STUB(xQueueGenericSend, 460)
PLAT_STUB(xQueueGenericSendFromISR, 461)
PLAT_STUB(xQueueGetMutexHolder, 462)
PLAT_STUB(xTaskCreate, 463)
PLAT_STUB(xTaskGenericNotify, 464)
PLAT_STUB(xTaskGetCurrentTaskHandle, 465)
PLAT_STUB(xTaskNotifyWait, 466)
