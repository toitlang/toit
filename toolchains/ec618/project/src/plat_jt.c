...
void *const g_plat_jt[PLAT_JT_COUNT] = {
    ...
    [PLAT_JT_USART2_DmaTxEvent] = &USART2_DmaTxEvent,
...
PLAT_STUB(USART1_DmaTxEvent, 220)
PLAT_STUB(USART1_IRQHandler, 221)
PLAT_STUB(USART2_DmaTxEvent, 222)
...
PLAT_STUB(WDT_deInit, 242)
PLAT_STUB(WDT_getStartStatus, 243)
PLAT_STUB(WDT_init, 244)
PLAT_STUB(WDT_kick, 245)
PLAT_STUB(WDT_start, 246)
PLAT_STUB(WDT_stop, 247)
PLAT_STUB(WDT_unlock, 248)
PLAT_STUB(XIC_EnableIRQ, 249)
PLAT_STUB(XIC_SetVector, 250)
PLAT_STUB(_ZNSt13random_device7_M_finiEv, 251)
PLAT_STUB(_ZNSt13random_device7_M_initERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE, 252)
PLAT_STUB(_ZNSt13random_device9_M_getvalEv, 253)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv, 254)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_S_copy_charsEPcPKcS7_, 255)
PLAT_STUB(_ZSt25__throw_bad_function_callv, 256)
PLAT_STUB(_ZdaPv, 257)
PLAT_STUB(_ZdlPv, 258)
PLAT_STUB(__aeabi_atexit, 259)
PLAT_STUB(__aeabi_cdcmpeq, 260)
PLAT_STUB(__aeabi_cdcmple, 261)
PLAT_STUB(__aeabi_cdrcmple, 262)
PLAT_STUB(__aeabi_d2f, 263)
PLAT_STUB(__aeabi_d2iz, 264)
PLAT_STUB(__aeabi_d2lz, 265)
PLAT_STUB(__aeabi_d2uiz, 266)
PLAT_STUB(__aeabi_d2ulz, 267)
PLAT_STUB(__aeabi_dadd, 268)
PLAT_STUB(__aeabi_dcmpeq, 269)
PLAT_STUB(__aeabi_dcmpge, 270)
PLAT_STUB(__aeabi_dcmpgt, 271)
PLAT_STUB(__aeabi_dcmple, 272)
PLAT_STUB(__aeabi_dcmplt, 273)
PLAT_STUB(__aeabi_dcmpun, 274)
PLAT_STUB(__aeabi_ddiv, 275)
PLAT_STUB(__aeabi_dmul, 276)
PLAT_STUB(__aeabi_drsub, 277)
PLAT_STUB(__aeabi_dsub, 278)
PLAT_STUB(__aeabi_f2d, 279)
PLAT_STUB(__aeabi_i2d, 280)
PLAT_STUB(__aeabi_l2d, 281)
PLAT_STUB(__aeabi_ldivmod, 282)
PLAT_STUB(__aeabi_ui2d, 283)
PLAT_STUB(__aeabi_ul2d, 284)
PLAT_STUB(__aeabi_uldivmod, 285)
PLAT_STUB(__assert_func, 286)
PLAT_STUB(__cxa_thread_atexit, 287)
PLAT_STUB(__emutls_get_address, 288)
PLAT_STUB(__popcountdi2, 289)
PLAT_STUB(__popcountsi2, 290)
PLAT_STUB(__wrap_time, 291)
PLAT_STUB(abort, 292)
PLAT_STUB(acos, 293)
PLAT_STUB(aligned_alloc, 294)
PLAT_STUB(apmuSetDeepestSleepMode, 295)
PLAT_STUB(appGetECBCInfoSync, 296)
PLAT_STUB(appSetCFUN, 297)
PLAT_STUB(asin, 298)
PLAT_STUB(atan, 299)
PLAT_STUB(atan2, 300)
PLAT_STUB(calloc, 301)
PLAT_STUB(ceil, 302)
PLAT_STUB(cos, 303)
PLAT_STUB(cosh, 304)
PLAT_STUB(delay_us, 305)
PLAT_STUB(deregisterPSEventCallback, 306)
PLAT_STUB(exp, 307)
PLAT_STUB(fabs, 308)
PLAT_STUB(fclose, 309)
PLAT_STUB(feof, 310)
PLAT_STUB(fflush, 311)
PLAT_STUB(floor, 312)
PLAT_STUB(fmod, 313)
PLAT_STUB(fopen, 314)
PLAT_STUB(fotaNvmNfsPeInit, 315)
PLAT_STUB(fputc, 316)
PLAT_STUB(fputs, 317)
PLAT_STUB(fread, 318)
PLAT_STUB(free, 319)
PLAT_STUB(fseek, 320)
PLAT_STUB(fwrite, 321)
PLAT_STUB(gmtime_r, 322)
PLAT_STUB(gpio_set_pad_wakeup_callback, 323)
PLAT_STUB(isspace, 324)
PLAT_STUB(localtime_r, 325)
PLAT_STUB(log, 326)
PLAT_STUB(luat_mobile_config, 327)
PLAT_STUB(luat_rtos_task_create, 328)
PLAT_STUB(luat_rtos_task_sleep, 329)
PLAT_STUB(luat_uart_exist, 330)
PLAT_STUB(luat_uart_write, 331)
PLAT_STUB(malloc, 332)
PLAT_STUB(memchr, 333)
PLAT_STUB(memcmp, 334)
PLAT_STUB(memcpy, 335)
PLAT_STUB(memmove, 336)
PLAT_STUB(memset, 337)
PLAT_STUB(mktime, 338)
PLAT_STUB(osDelay, 339)
PLAT_STUB(osKernelGetTickCount, 340)
PLAT_STUB(pbuf_alloc, 341)
PLAT_STUB(pbuf_cat, 342)
PLAT_STUB(pbuf_free, 343)
PLAT_STUB(pbuf_ref, 344)
PLAT_STUB(pow, 345)
PLAT_STUB(printf, 346)
PLAT_STUB(psSetCdgcont, 347)
PLAT_STUB(putchar, 348)
PLAT_STUB(putenv, 349)
PLAT_STUB(puts, 350)
PLAT_STUB(pwrKeyIntHandler, 351)
PLAT_STUB(rand, 352)
PLAT_STUB(realloc, 353)
PLAT_STUB(registerPSEventCallback, 354)
PLAT_STUB(rngGenRandom, 355)
PLAT_STUB(round, 356)
PLAT_STUB(sin, 357)
PLAT_STUB(sinh, 358)
PLAT_STUB(slot_marker_read, 359)
PLAT_STUB(slot_marker_write, 360)
PLAT_STUB(slpManAONIOLatchEn, 361)
PLAT_STUB(slpManAONIOPowerOff, 362)
PLAT_STUB(slpManAONIOPowerOn, 363)
PLAT_STUB(slpManAONIOVoltGet, 364)
PLAT_STUB(slpManAONIOVoltSet, 365)
PLAT_STUB(slpManAonWdtFeed, 366)
PLAT_STUB(slpManAonWdtStop, 367)
PLAT_STUB(slpManApplyPlatVoteHandle, 368)
PLAT_STUB(slpManDeepSlpTimerDel, 369)
PLAT_STUB(slpManDeepSlpTimerRegisterExpCb, 370)
PLAT_STUB(slpManDeepSlpTimerStart, 371)
PLAT_STUB(slpManDrvVoteSleep, 372)
PLAT_STUB(slpManExcutePredefinedBackupCb, 373)
PLAT_STUB(slpManExcutePredefinedBackupCbInPaging, 374)
PLAT_STUB(slpManExcutePredefinedRestoreCb, 375)
PLAT_STUB(slpManExcutePredefinedRestoreCbInPaging, 376)
PLAT_STUB(slpManExcuteUsrdefinedBackupCb, 377)
PLAT_STUB(slpManExcuteUsrdefinedRestoreCb, 378)
PLAT_STUB(slpManExtIntPreProcess, 379)
PLAT_STUB(slpManGetDrvBitmap, 380)
PLAT_STUB(slpManGetDrvVoteMask, 381)
PLAT_STUB(slpManGetLastSlpState, 382)
PLAT_STUB(slpManGetWakeupPadCfg, 383)
PLAT_STUB(slpManGetWakeupPinValue, 384)
PLAT_STUB(slpManGivebackPlatVoteHandle, 385)
PLAT_STUB(slpManPlatGetSlpState, 386)
PLAT_STUB(slpManPlatVoteDisableSleep, 387)
PLAT_STUB(slpManPlatVoteEnableSleep, 388)
PLAT_STUB(slpManProductionTest, 389)
PLAT_STUB(slpManRegisterPredefinedBackupCb, 390)
PLAT_STUB(slpManRegisterPredefinedRestoreCb, 391)
PLAT_STUB(slpManSetDrvVoteMask, 392)
PLAT_STUB(slpManSetPmuSleepMode, 393)
PLAT_STUB(slpManSetWakeupPadCfg, 394)
PLAT_STUB(slpManStartPowerOff, 395)
PLAT_STUB(slpManUnregisterPredefinedBackupCb, 396)
PLAT_STUB(slpManUnregisterPredefinedRestoreCb, 397)
PLAT_STUB(slpManUpdatePmuTimingCfg, 398)
PLAT_STUB(snprintf, 399)
PLAT_STUB(soc_call_function_in_service, 400)
PLAT_STUB(soc_cms_proc, 401)
PLAT_STUB(soc_disable_tcpip_use_default_pdp, 402)
PLAT_STUB(soc_fast_printf, 403)
PLAT_STUB(soc_free_later, 404)
PLAT_STUB(soc_get_poweron_time_ms, 405)
PLAT_STUB(soc_get_poweron_time_tick, 406)
PLAT_STUB(soc_info, 407)
PLAT_STUB(soc_mobile_default_pdn_ip_type, 408)
PLAT_STUB(soc_mobile_search_cell_info_async, 409)
PLAT_STUB(soc_mobile_set_rrc_release_time, 410)
PLAT_STUB(soc_netif_input_prepare, 411)
PLAT_STUB(soc_power_mode, 412)
PLAT_STUB(soc_printf, 413)
PLAT_STUB(soc_set_usb_sleep, 414)
PLAT_STUB(soc_uart0_set_log_off, 415)
PLAT_STUB(soc_unilog_callback, 416)
PLAT_STUB(soc_usb_onoff, 417)
PLAT_STUB(soc_usb_serial_output, 418)
PLAT_STUB(soc_vsprintf, 419)
PLAT_STUB(sprintf, 420)
PLAT_STUB(sqrt, 421)
PLAT_STUB(srand, 422)
PLAT_STUB(sscanf, 423)
PLAT_STUB(strcat, 424)
PLAT_STUB(strchr, 425)
PLAT_STUB(strcmp, 426)
PLAT_STUB(strcpy, 427)
PLAT_STUB(strcspn, 428)
PLAT_STUB(strdup, 429)
PLAT_STUB(strerror, 430)
PLAT_STUB(strlen, 431)
PLAT_STUB(strncat, 432)
PLAT_STUB(strncmp, 433)
PLAT_STUB(strncpy, 434)
PLAT_STUB(strnlen, 435)
PLAT_STUB(strspn, 436)
PLAT_STUB(strstr, 437)
PLAT_STUB(strtod, 438)
PLAT_STUB(strtoul, 439)
PLAT_STUB(tan, 440)
PLAT_STUB(tanh, 441)
PLAT_STUB(tcp_accept, 442)
PLAT_STUB(tcp_arg, 443)
PLAT_STUB(tcp_bind, 444)
PLAT_STUB(tcp_close, 445)
PLAT_STUB(tcp_connect, 446)
PLAT_STUB(tcp_err, 447)
PLAT_STUB(tcp_listen_with_backlog, 448)
PLAT_STUB(tcp_new, 449)
PLAT_STUB(tcp_output, 450)
PLAT_STUB(tcp_recv, 451)
PLAT_STUB(tcp_recved, 452)
PLAT_STUB(tcp_sent, 453)
PLAT_STUB(tcp_shutdown, 454)
PLAT_STUB(tcp_write, 455)
PLAT_STUB(tcpip_callback_with_block, 456)
PLAT_STUB(trimAdcSetGolbalVar, 457)
PLAT_STUB(trunc, 458)
PLAT_STUB(tzset, 459)
PLAT_STUB(udp_bind, 460)
PLAT_STUB(udp_connect, 461)
PLAT_STUB(udp_new, 462)
PLAT_STUB(udp_recv, 463)
PLAT_STUB(udp_remove, 464)
PLAT_STUB(udp_send, 465)
PLAT_STUB(udp_sendto, 466)
PLAT_STUB(vPortGetHeapStats, 467)
PLAT_STUB(vPortGetHeapTag, 468)
PLAT_STUB(vPortIterateAllocations, 469)
PLAT_STUB(vPortSetHeapTag, 470)
PLAT_STUB(vQueueDelete, 471)
PLAT_STUB(vTaskDelete, 472)
PLAT_STUB(vfprintf, 473)
PLAT_STUB(vsnprintf, 474)
PLAT_STUB(xQueueCreateMutex, 475)
PLAT_STUB(xQueueGenericCreate, 476)
PLAT_STUB(xQueueGenericReceive, 477)
PLAT_STUB(xQueueGenericSend, 478)
PLAT_STUB(xQueueGenericSendFromISR, 479)
PLAT_STUB(xQueueGetMutexHolder, 480)
PLAT_STUB(xTaskCreate, 481)
PLAT_STUB(xTaskGenericNotify, 482)
PLAT_STUB(xTaskGetCurrentTaskHandle, 483)
PLAT_STUB(xTaskNotifyWait, 484)
