...
PLAT_STUB(SPI_BlockTransfer, 188)
PLAT_STUB(SPI_FastTransfer, 189)
PLAT_STUB(SPI_FlashBlockTransfer, 190)
PLAT_STUB(SPI_GetSpeed, 191)
PLAT_STUB(SPI_IsTransferBusy, 192)
PLAT_STUB(SPI_MasterInit, 193)
PLAT_STUB(SPI_SetCallbackFun, 194)
PLAT_STUB(SPI_SetDMAEnable, 195)
PLAT_STUB(SPI_SetDMATrigger, 196)
PLAT_STUB(SPI_SetNewConfig, 197)
PLAT_STUB(SPI_SetNoBlock, 198)
PLAT_STUB(SPI_SetTxOnlyFlag, 199)
PLAT_STUB(SPI_TransferEx, 200)
PLAT_STUB(SPI_TransferStop, 201)
PLAT_STUB(SPI_WaitTransferNoBusy, 202)
PLAT_STUB(TIMER_clearInterruptFlags, 203)
PLAT_STUB(TIMER_deInit, 204)
PLAT_STUB(TIMER_driverInit, 205)
PLAT_STUB(TIMER_getDefaultConfig, 206)
PLAT_STUB(TIMER_getInterruptFlags, 207)
PLAT_STUB(TIMER_init, 208)
PLAT_STUB(TIMER_interruptConfig, 209)
PLAT_STUB(TIMER_start, 210)
PLAT_STUB(TIMER_stop, 211)
PLAT_STUB(UART_flush, 212)
PLAT_STUB(UART_init, 213)
PLAT_STUB(UART_receive, 214)
PLAT_STUB(UART_send, 215)
PLAT_STUB(UART_setBaudrate, 216)
PLAT_STUB(USART0_IRQHandler, 217)
PLAT_STUB(USART1_DmaRxEvent, 218)
PLAT_STUB(USART1_DmaTxEvent, 219)
PLAT_STUB(USART1_IRQHandler, 220)
PLAT_STUB(USART2_DmaRxEvent, 221)
PLAT_STUB(USART2_IRQHandler, 222)
PLAT_STUB(USART_Control, 223)
PLAT_STUB(USART_DmaRxEvent, 224)
PLAT_STUB(USART_DmaTxEvent, 225)
PLAT_STUB(USART_GetBaudRate, 226)
PLAT_STUB(USART_GetCapabilities, 227)
PLAT_STUB(USART_GetModemStatus, 228)
PLAT_STUB(USART_GetRxCount, 229)
PLAT_STUB(USART_GetStatus, 230)
PLAT_STUB(USART_GetTxCount, 231)
PLAT_STUB(USART_IRQHandler, 232)
PLAT_STUB(USART_Initialize, 233)
PLAT_STUB(USART_PowerControl, 234)
PLAT_STUB(USART_Receive, 235)
PLAT_STUB(USART_Send, 236)
PLAT_STUB(USART_SendPolling, 237)
PLAT_STUB(USART_SetBaudrate, 238)
PLAT_STUB(USART_SetModemControl, 239)
PLAT_STUB(USART_Uninitialize, 240)
PLAT_STUB(Uart_BaseInitEx, 241)
PLAT_STUB(Uart_ChangeBR, 242)
PLAT_STUB(Uart_DeInit, 243)
PLAT_STUB(Uart_IsTSREmpty, 244)
PLAT_STUB(Uart_RxBufferClear, 245)
PLAT_STUB(Uart_RxBufferRead, 246)
PLAT_STUB(Uart_TxTaskSafe, 247)
PLAT_STUB(WDT_deInit, 248)
PLAT_STUB(WDT_getStartStatus, 249)
PLAT_STUB(WDT_init, 250)
PLAT_STUB(WDT_kick, 251)
PLAT_STUB(WDT_start, 252)
PLAT_STUB(WDT_stop, 253)
PLAT_STUB(WDT_unlock, 254)
PLAT_STUB(XIC_EnableIRQ, 255)
PLAT_STUB(XIC_SetVector, 256)
PLAT_STUB(_ZNSt13random_device7_M_finiEv, 257)
PLAT_STUB(_ZNSt13random_device7_M_initERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE, 258)
PLAT_STUB(_ZNSt13random_device9_M_getvalEv, 259)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv, 260)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_S_copy_charsEPcPKcS7_, 261)
PLAT_STUB(_ZSt25__throw_bad_function_callv, 262)
PLAT_STUB(_ZdaPv, 263)
PLAT_STUB(_ZdlPv, 264)
PLAT_STUB(__aeabi_atexit, 265)
PLAT_STUB(__aeabi_cdcmpeq, 266)
PLAT_STUB(__aeabi_cdcmple, 267)
PLAT_STUB(__aeabi_cdrcmple, 268)
PLAT_STUB(__aeabi_d2f, 269)
PLAT_STUB(__aeabi_d2iz, 270)
PLAT_STUB(__aeabi_d2lz, 271)
PLAT_STUB(__aeabi_d2uiz, 272)
PLAT_STUB(__aeabi_d2ulz, 273)
PLAT_STUB(__aeabi_dadd, 274)
PLAT_STUB(__aeabi_dcmpeq, 275)
PLAT_STUB(__aeabi_dcmpge, 276)
PLAT_STUB(__aeabi_dcmpgt, 277)
PLAT_STUB(__aeabi_dcmple, 278)
PLAT_STUB(__aeabi_dcmplt, 279)
PLAT_STUB(__aeabi_dcmpun, 280)
PLAT_STUB(__aeabi_ddiv, 281)
PLAT_STUB(__aeabi_dmul, 282)
PLAT_STUB(__aeabi_drsub, 283)
PLAT_STUB(__aeabi_dsub, 284)
PLAT_STUB(__aeabi_f2d, 285)
PLAT_STUB(__aeabi_i2d, 286)
PLAT_STUB(__aeabi_l2d, 287)
PLAT_STUB(__aeabi_ldivmod, 288)
PLAT_STUB(__aeabi_ui2d, 289)
PLAT_STUB(__aeabi_ul2d, 290)
PLAT_STUB(__aeabi_uldivmod, 291)
PLAT_STUB(__assert_func, 292)
PLAT_STUB(__cxa_thread_atexit, 293)
PLAT_STUB(__emutls_get_address, 294)
PLAT_STUB(__popcountdi2, 295)
PLAT_STUB(__popcountsi2, 296)
PLAT_STUB(__wrap_time, 297)
PLAT_STUB(abort, 298)
PLAT_STUB(acos, 299)
PLAT_STUB(aligned_alloc, 300)
PLAT_STUB(apmuSetDeepestSleepMode, 301)
PLAT_STUB(appGetECBCInfoSync, 302)
PLAT_STUB(appSetCFUN, 303)
PLAT_STUB(asin, 304)
PLAT_STUB(atan, 305)
PLAT_STUB(atan2, 306)
PLAT_STUB(calloc, 307)
PLAT_STUB(ceil, 308)
PLAT_STUB(cos, 309)
PLAT_STUB(cosh, 310)
PLAT_STUB(delay_us, 311)
PLAT_STUB(deregisterPSEventCallback, 312)
PLAT_STUB(exp, 313)
PLAT_STUB(fabs, 314)
PLAT_STUB(fclose, 315)
PLAT_STUB(feof, 316)
PLAT_STUB(fflush, 317)
PLAT_STUB(floor, 318)
PLAT_STUB(fmod, 319)
PLAT_STUB(fopen, 320)
PLAT_STUB(fotaNvmNfsPeInit, 321)
PLAT_STUB(fputc, 322)
PLAT_STUB(fputs, 323)
PLAT_STUB(fread, 324)
PLAT_STUB(free, 325)
PLAT_STUB(fseek, 326)
PLAT_STUB(fwrite, 327)
PLAT_STUB(gmtime_r, 328)
PLAT_STUB(gpio_set_pad_wakeup_callback, 329)
PLAT_STUB(isspace, 330)
PLAT_STUB(localtime_r, 331)
PLAT_STUB(log, 332)
PLAT_STUB(luat_mobile_config, 333)
PLAT_STUB(luat_rtos_task_create, 334)
PLAT_STUB(luat_rtos_task_sleep, 335)
PLAT_STUB(luat_uart_exist, 336)
PLAT_STUB(luat_uart_write, 337)
PLAT_STUB(malloc, 338)
PLAT_STUB(memchr, 339)
PLAT_STUB(memcmp, 340)
PLAT_STUB(memcpy, 341)
PLAT_STUB(memmove, 342)
PLAT_STUB(memset, 343)
PLAT_STUB(mktime, 344)
PLAT_STUB(osDelay, 345)
PLAT_STUB(osKernelGetTickCount, 346)
PLAT_STUB(pbuf_alloc, 347)
PLAT_STUB(pbuf_cat, 348)
PLAT_STUB(pbuf_free, 349)
PLAT_STUB(pbuf_ref, 350)
PLAT_STUB(pow, 351)
PLAT_STUB(printf, 352)
PLAT_STUB(psSetCdgcont, 353)
PLAT_STUB(putchar, 354)
PLAT_STUB(putenv, 355)
PLAT_STUB(puts, 356)
PLAT_STUB(pwrKeyIntHandler, 357)
PLAT_STUB(rand, 358)
PLAT_STUB(realloc, 359)
PLAT_STUB(registerPSEventCallback, 360)
PLAT_STUB(rngGenRandom, 361)
PLAT_STUB(round, 362)
PLAT_STUB(sin, 363)
PLAT_STUB(sinh, 364)
PLAT_STUB(slot_marker_read, 365)
PLAT_STUB(slot_marker_write, 366)
PLAT_STUB(slpManAonWdtFeed, 367)
PLAT_STUB(slpManAonWdtStop, 368)
PLAT_STUB(slpManApplyPlatVoteHandle, 369)
PLAT_STUB(slpManDeepSlpTimerDel, 370)
PLAT_STUB(slpManDeepSlpTimerRegisterExpCb, 371)
PLAT_STUB(slpManDeepSlpTimerStart, 372)
PLAT_STUB(slpManDrvVoteSleep, 373)
PLAT_STUB(slpManExcutePredefinedBackupCb, 374)
PLAT_STUB(slpManExcutePredefinedBackupCbInPaging, 375)
PLAT_STUB(slpManExcutePredefinedRestoreCb, 376)
PLAT_STUB(slpManExcutePredefinedRestoreCbInPaging, 377)
PLAT_STUB(slpManExcuteUsrdefinedBackupCb, 378)
PLAT_STUB(slpManExcuteUsrdefinedRestoreCb, 379)
PLAT_STUB(slpManExtIntPreProcess, 380)
PLAT_STUB(slpManGetDrvBitmap, 381)
PLAT_STUB(slpManGetDrvVoteMask, 382)
PLAT_STUB(slpManGetLastSlpState, 383)
PLAT_STUB(slpManGetWakeupPadCfg, 384)
PLAT_STUB(slpManGetWakeupPinValue, 385)
PLAT_STUB(slpManGivebackPlatVoteHandle, 386)
PLAT_STUB(slpManPlatGetSlpState, 387)
PLAT_STUB(slpManPlatVoteDisableSleep, 388)
PLAT_STUB(slpManPlatVoteEnableSleep, 389)
PLAT_STUB(slpManProductionTest, 390)
PLAT_STUB(slpManRegisterPredefinedBackupCb, 391)
PLAT_STUB(slpManRegisterPredefinedRestoreCb, 392)
PLAT_STUB(slpManSetDrvVoteMask, 393)
PLAT_STUB(slpManSetPmuSleepMode, 394)
PLAT_STUB(slpManSetWakeupPadCfg, 395)
PLAT_STUB(slpManStartPowerOff, 396)
PLAT_STUB(slpManUnregisterPredefinedBackupCb, 397)
PLAT_STUB(slpManUnregisterPredefinedRestoreCb, 398)
PLAT_STUB(slpManUpdatePmuTimingCfg, 399)
PLAT_STUB(snprintf, 400)
PLAT_STUB(soc_call_function_in_service, 401)
PLAT_STUB(soc_cms_proc, 402)
PLAT_STUB(soc_disable_tcpip_use_default_pdp, 403)
PLAT_STUB(soc_fast_printf, 404)
PLAT_STUB(soc_free_later, 405)
PLAT_STUB(soc_get_poweron_time_ms, 406)
PLAT_STUB(soc_get_poweron_time_tick, 407)
PLAT_STUB(soc_info, 408)
PLAT_STUB(soc_mobile_default_pdn_ip_type, 409)
PLAT_STUB(soc_mobile_search_cell_info_async, 410)
PLAT_STUB(soc_mobile_set_rrc_release_time, 411)
PLAT_STUB(soc_netif_input_prepare, 412)
PLAT_STUB(soc_power_mode, 413)
PLAT_STUB(soc_printf, 414)
PLAT_STUB(soc_set_usb_sleep, 415)
PLAT_STUB(soc_uart0_set_log_off, 416)
PLAT_STUB(soc_unilog_callback, 417)
PLAT_STUB(soc_usb_onoff, 418)
PLAT_STUB(soc_usb_serial_output, 419)
PLAT_STUB(soc_vsprintf, 420)
PLAT_STUB(sprintf, 421)
PLAT_STUB(sqrt, 422)
PLAT_STUB(srand, 423)
PLAT_STUB(sscanf, 424)
PLAT_STUB(strcat, 425)
PLAT_STUB(strchr, 426)
PLAT_STUB(strcmp, 427)
PLAT_STUB(strcpy, 428)
PLAT_STUB(strcspn, 429)
PLAT_STUB(strdup, 430)
PLAT_STUB(strerror, 431)
PLAT_STUB(strlen, 432)
PLAT_STUB(strncat, 433)
PLAT_STUB(strncmp, 434)
PLAT_STUB(strncpy, 435)
PLAT_STUB(strnlen, 436)
PLAT_STUB(strspn, 437)
PLAT_STUB(strstr, 438)
PLAT_STUB(strtod, 439)
PLAT_STUB(strtoul, 440)
PLAT_STUB(tan, 441)
PLAT_STUB(tanh, 442)
PLAT_STUB(tcp_accept, 443)
PLAT_STUB(tcp_arg, 444)
PLAT_STUB(tcp_bind, 445)
PLAT_STUB(tcp_close, 446)
PLAT_STUB(tcp_connect, 447)
PLAT_STUB(tcp_err, 448)
PLAT_STUB(tcp_listen_with_backlog, 449)
PLAT_STUB(tcp_new, 450)
PLAT_STUB(tcp_output, 451)
PLAT_STUB(tcp_recv, 452)
PLAT_STUB(tcp_recved, 453)
PLAT_STUB(tcp_sent, 454)
PLAT_STUB(tcp_shutdown, 455)
PLAT_STUB(tcp_write, 456)
PLAT_STUB(tcpip_callback_with_block, 457)
PLAT_STUB(trimAdcSetGolbalVar, 458)
PLAT_STUB(trunc, 459)
PLAT_STUB(tzset, 460)
PLAT_STUB(udp_bind, 461)
PLAT_STUB(udp_connect, 462)
PLAT_STUB(udp_new, 463)
PLAT_STUB(udp_recv, 464)
PLAT_STUB(udp_remove, 465)
PLAT_STUB(udp_send, 466)
PLAT_STUB(udp_sendto, 467)
PLAT_STUB(vPortGetHeapStats, 468)
PLAT_STUB(vPortGetHeapTag, 469)
PLAT_STUB(vPortIterateAllocations, 470)
PLAT_STUB(vPortSetHeapTag, 471)
PLAT_STUB(vQueueDelete, 472)
PLAT_STUB(vTaskDelete, 473)
PLAT_STUB(vfprintf, 474)
PLAT_STUB(vsnprintf, 475)
PLAT_STUB(xQueueCreateMutex, 476)
PLAT_STUB(xQueueGenericCreate, 477)
PLAT_STUB(xQueueGenericReceive, 478)
PLAT_STUB(xQueueGenericSend, 479)
PLAT_STUB(xQueueGenericSendFromISR, 480)
PLAT_STUB(xQueueGetMutexHolder, 481)
PLAT_STUB(xTaskCreate, 482)
PLAT_STUB(xTaskGenericNotify, 483)
PLAT_STUB(xTaskGetCurrentTaskHandle, 484)
PLAT_STUB(xTaskNotifyWait, 485)
