...
extern void *USART0_DmaRxEvent;
extern void *USART0_DmaTxEvent;
...
extern void *slpManGetWakeupSrc;
...
void *const g_plat_jt[PLAT_JT_COUNT] = {
    ...
    [PLAT_JT_I2C0_IRQHandler] = &I2C0_IRQHandler,
    [PLAT_JT_I2C1_IRQHandler] = &I2C1_IRQHandler,
    ...
    [PLAT_JT_I2C_IRQHandler] = &I2C_IRQHandler,
    ...
    [PLAT_JT_USART0_DmaRxEvent] = &USART0_DmaRxEvent,
    [PLAT_JT_USART0_DmaTxEvent] = &USART0_DmaTxEvent,
    ...
    [PLAT_JT_slpManGetWakeupSrc] = &slpManGetWakeupSrc,
...
PLAT_STUB(I2C0_IRQHandler, 149)
PLAT_STUB(I2C1_IRQHandler, 150)
PLAT_STUB(I2C_Control, 151)
PLAT_STUB(I2C_GetCapabilities, 152)
PLAT_STUB(I2C_GetClockFreq, 153)
PLAT_STUB(I2C_GetDataCount, 154)
PLAT_STUB(I2C_GetStatus, 155)
PLAT_STUB(I2C_IRQHandler, 156)
PLAT_STUB(I2C_Initialize, 157)
PLAT_STUB(I2C_MasterReceive, 158)
PLAT_STUB(I2C_MasterTransmit, 159)
PLAT_STUB(I2C_PowerControl, 160)
PLAT_STUB(I2C_SlaveReceive, 161)
PLAT_STUB(I2C_Uninitialize, 162)
PLAT_STUB(OsaSystemTimeReadRamUtc, 163)
PLAT_STUB(OsaTimerSync, 164)
PLAT_STUB(PAD_driverInit, 165)
PLAT_STUB(PAD_enterLowPowerStatePrepare, 166)
PLAT_STUB(PAD_exitLowPowerStateRestore, 167)
PLAT_STUB(PAD_getDefaultConfig, 168)
PLAT_STUB(PAD_setPinConfig, 169)
PLAT_STUB(PAD_setPinPullConfig, 170)
PLAT_STUB(Pad0_WakeupIntHandler, 171)
PLAT_STUB(Pad1_WakeupIntHandler, 172)
PLAT_STUB(Pad2_WakeupIntHandler, 173)
PLAT_STUB(Pad3_WakeupIntHandler, 174)
PLAT_STUB(Pad4_WakeupIntHandler, 175)
PLAT_STUB(Pad5_WakeupIntHandler, 176)
PLAT_STUB(QSPI_CheckQEnFlag, 177)
PLAT_STUB(QSPI_PollingBusyFlagIntableOnce, 178)
PLAT_STUB(RTC_WakeupIntHandler, 179)
PLAT_STUB(ResetStateGet, 180)
PLAT_STUB(SPI0_IrqHandler, 181)
PLAT_STUB(SPI1_IrqHandler, 182)
PLAT_STUB(SPI_BlockTransfer, 183)
PLAT_STUB(SPI_FastTransfer, 184)
PLAT_STUB(SPI_FlashBlockTransfer, 185)
PLAT_STUB(SPI_GetSpeed, 186)
PLAT_STUB(SPI_IsTransferBusy, 187)
PLAT_STUB(SPI_MasterInit, 188)
PLAT_STUB(SPI_SetCallbackFun, 189)
PLAT_STUB(SPI_SetDMAEnable, 190)
PLAT_STUB(SPI_SetDMATrigger, 191)
PLAT_STUB(SPI_SetNewConfig, 192)
PLAT_STUB(SPI_SetNoBlock, 193)
PLAT_STUB(SPI_SetTxOnlyFlag, 194)
PLAT_STUB(SPI_TransferEx, 195)
PLAT_STUB(SPI_TransferStop, 196)
PLAT_STUB(SPI_WaitTransferNoBusy, 197)
PLAT_STUB(TIMER_clearInterruptFlags, 198)
PLAT_STUB(TIMER_deInit, 199)
PLAT_STUB(TIMER_driverInit, 200)
PLAT_STUB(TIMER_getDefaultConfig, 201)
PLAT_STUB(TIMER_getInterruptFlags, 202)
PLAT_STUB(TIMER_init, 203)
PLAT_STUB(TIMER_interruptConfig, 204)
PLAT_STUB(TIMER_start, 205)
PLAT_STUB(TIMER_stop, 206)
PLAT_STUB(UART_flush, 207)
PLAT_STUB(UART_init, 208)
PLAT_STUB(UART_receive, 209)
PLAT_STUB(UART_send, 210)
PLAT_STUB(UART_setBaudrate, 211)
PLAT_STUB(USART0_DmaRxEvent, 212)
PLAT_STUB(USART0_DmaTxEvent, 213)
PLAT_STUB(USART0_IRQHandler, 214)
PLAT_STUB(USART1_DmaRxEvent, 215)
PLAT_STUB(USART1_DmaTxEvent, 216)
PLAT_STUB(USART1_IRQHandler, 217)
PLAT_STUB(USART2_DmaRxEvent, 218)
PLAT_STUB(USART2_DmaTxEvent, 219)
PLAT_STUB(USART2_IRQHandler, 220)
PLAT_STUB(USART_Control, 221)
PLAT_STUB(USART_DmaRxEvent, 222)
PLAT_STUB(USART_DmaTxEvent, 223)
PLAT_STUB(USART_GetBaudRate, 224)
PLAT_STUB(USART_GetCapabilities, 225)
PLAT_STUB(USART_GetModemStatus, 226)
PLAT_STUB(USART_GetRxCount, 227)
PLAT_STUB(USART_GetStatus, 228)
PLAT_STUB(USART_GetTxCount, 229)
PLAT_STUB(USART_IRQHandler, 230)
PLAT_STUB(USART_Initialize, 231)
PLAT_STUB(USART_PowerControl, 232)
PLAT_STUB(USART_Receive, 233)
PLAT_STUB(USART_Send, 234)
PLAT_STUB(USART_SendPolling, 235)
PLAT_STUB(USART_SetBaudrate, 236)
PLAT_STUB(USART_SetModemControl, 237)
PLAT_STUB(USART_Uninitialize, 238)
PLAT_STUB(WDT_deInit, 239)
PLAT_STUB(WDT_getStartStatus, 240)
PLAT_STUB(WDT_init, 241)
PLAT_STUB(WDT_kick, 242)
PLAT_STUB(WDT_start, 243)
PLAT_STUB(WDT_stop, 244)
PLAT_STUB(WDT_unlock, 245)
PLAT_STUB(XIC_EnableIRQ, 246)
PLAT_STUB(XIC_SetVector, 247)
PLAT_STUB(_ZNSt13random_device7_M_finiEv, 248)
PLAT_STUB(_ZNSt13random_device7_M_initERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE, 249)
PLAT_STUB(_ZNSt13random_device9_M_getvalEv, 250)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_disposeEv, 251)
PLAT_STUB(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_S_copy_charsEPcPKcS7_, 252)
PLAT_STUB(_ZSt25__throw_bad_function_callv, 253)
PLAT_STUB(_ZdaPv, 254)
PLAT_STUB(_ZdlPv, 255)
PLAT_STUB(__aeabi_atexit, 256)
PLAT_STUB(__aeabi_cdcmpeq, 257)
PLAT_STUB(__aeabi_cdcmple, 258)
PLAT_STUB(__aeabi_cdrcmple, 259)
PLAT_STUB(__aeabi_d2f, 260)
PLAT_STUB(__aeabi_d2iz, 261)
PLAT_STUB(__aeabi_d2lz, 262)
PLAT_STUB(__aeabi_d2uiz, 263)
PLAT_STUB(__aeabi_d2ulz, 264)
PLAT_STUB(__aeabi_dadd, 265)
PLAT_STUB(__aeabi_dcmpeq, 266)
PLAT_STUB(__aeabi_dcmpge, 267)
PLAT_STUB(__aeabi_dcmpgt, 268)
PLAT_STUB(__aeabi_dcmple, 269)
PLAT_STUB(__aeabi_dcmplt, 270)
PLAT_STUB(__aeabi_dcmpun, 271)
PLAT_STUB(__aeabi_ddiv, 272)
PLAT_STUB(__aeabi_dmul, 273)
PLAT_STUB(__aeabi_drsub, 274)
PLAT_STUB(__aeabi_dsub, 275)
PLAT_STUB(__aeabi_f2d, 276)
PLAT_STUB(__aeabi_i2d, 277)
PLAT_STUB(__aeabi_l2d, 278)
PLAT_STUB(__aeabi_ldivmod, 279)
PLAT_STUB(__aeabi_ui2d, 280)
PLAT_STUB(__aeabi_ul2d, 281)
PLAT_STUB(__aeabi_uldivmod, 282)
PLAT_STUB(__assert_func, 283)
PLAT_STUB(__cxa_thread_atexit, 284)
PLAT_STUB(__emutls_get_address, 285)
PLAT_STUB(__popcountdi2, 286)
PLAT_STUB(__popcountsi2, 287)
PLAT_STUB(__wrap_time, 288)
PLAT_STUB(abort, 289)
PLAT_STUB(acos, 290)
PLAT_STUB(aligned_alloc, 291)
PLAT_STUB(apmuSetDeepestSleepMode, 292)
PLAT_STUB(appGetECBCInfoSync, 293)
PLAT_STUB(appSetCFUN, 294)
PLAT_STUB(asin, 295)
PLAT_STUB(atan, 296)
PLAT_STUB(atan2, 297)
PLAT_STUB(calloc, 298)
PLAT_STUB(ceil, 299)
PLAT_STUB(cos, 300)
PLAT_STUB(cosh, 301)
PLAT_STUB(delay_us, 302)
PLAT_STUB(deregisterPSEventCallback, 303)
PLAT_STUB(exp, 304)
PLAT_STUB(fabs, 305)
PLAT_STUB(fclose, 306)
PLAT_STUB(feof, 307)
PLAT_STUB(fflush, 308)
PLAT_STUB(floor, 309)
PLAT_STUB(fmod, 310)
PLAT_STUB(fopen, 311)
PLAT_STUB(fotaNvmNfsPeInit, 312)
PLAT_STUB(fputc, 313)
PLAT_STUB(fputs, 314)
PLAT_STUB(fread, 315)
PLAT_STUB(free, 316)
PLAT_STUB(fseek, 317)
PLAT_STUB(fwrite, 318)
PLAT_STUB(gmtime_r, 319)
PLAT_STUB(gpio_set_pad_wakeup_callback, 320)
PLAT_STUB(isspace, 321)
PLAT_STUB(localtime_r, 322)
PLAT_STUB(log, 323)
PLAT_STUB(luat_mobile_config, 324)
PLAT_STUB(luat_rtos_task_create, 325)
PLAT_STUB(luat_rtos_task_sleep, 326)
PLAT_STUB(luat_uart_exist, 327)
PLAT_STUB(luat_uart_write, 328)
PLAT_STUB(malloc, 329)
PLAT_STUB(memchr, 330)
PLAT_STUB(memcmp, 331)
PLAT_STUB(memcpy, 332)
PLAT_STUB(memmove, 333)
PLAT_STUB(memset, 334)
PLAT_STUB(mktime, 335)
PLAT_STUB(osDelay, 336)
PLAT_STUB(osKernelGetTickCount, 337)
PLAT_STUB(pbuf_alloc, 338)
PLAT_STUB(pbuf_cat, 339)
PLAT_STUB(pbuf_free, 340)
PLAT_STUB(pbuf_ref, 341)
PLAT_STUB(pow, 342)
PLAT_STUB(printf, 343)
PLAT_STUB(psSetCdgcont, 344)
PLAT_STUB(putchar, 345)
PLAT_STUB(putenv, 346)
PLAT_STUB(puts, 347)
PLAT_STUB(pwrKeyIntHandler, 348)
PLAT_STUB(rand, 349)
PLAT_STUB(realloc, 350)
PLAT_STUB(registerPSEventCallback, 351)
PLAT_STUB(rngGenRandom, 352)
PLAT_STUB(round, 353)
PLAT_STUB(sin, 354)
PLAT_STUB(sinh, 355)
PLAT_STUB(slot_marker_read, 356)
PLAT_STUB(slot_marker_write, 357)
PLAT_STUB(slpManAONIOLatchEn, 358)
PLAT_STUB(slpManAONIOPowerOff, 359)
PLAT_STUB(slpManAONIOPowerOn, 360)
PLAT_STUB(slpManAONIOVoltGet, 361)
PLAT_STUB(slpManAONIOVoltSet, 362)
PLAT_STUB(slpManAonWdtFeed, 363)
PLAT_STUB(slpManAonWdtStop, 364)
PLAT_STUB(slpManApplyPlatVoteHandle, 365)
PLAT_STUB(slpManDeepSlpTimerDel, 366)
PLAT_STUB(slpManDeepSlpTimerRegisterExpCb, 367)
PLAT_STUB(slpManDeepSlpTimerStart, 368)
PLAT_STUB(slpManDrvVoteSleep, 369)
PLAT_STUB(slpManExcutePredefinedBackupCb, 370)
PLAT_STUB(slpManExcutePredefinedBackupCbInPaging, 371)
PLAT_STUB(slpManExcutePredefinedRestoreCb, 372)
PLAT_STUB(slpManExcutePredefinedRestoreCbInPaging, 373)
PLAT_STUB(slpManExcuteUsrdefinedBackupCb, 374)
PLAT_STUB(slpManExcuteUsrdefinedRestoreCb, 375)
PLAT_STUB(slpManExtIntPreProcess, 376)
PLAT_STUB(slpManGetDrvBitmap, 377)
PLAT_STUB(slpManGetDrvVoteMask, 378)
PLAT_STUB(slpManGetLastSlpState, 379)
PLAT_STUB(slpManGetWakeupPadCfg, 380)
PLAT_STUB(slpManGetWakeupPinValue, 381)
PLAT_STUB(slpManGetWakeupSrc, 382)
PLAT_STUB(slpManGivebackPlatVoteHandle, 383)
PLAT_STUB(slpManPlatGetSlpState, 384)
PLAT_STUB(slpManPlatVoteDisableSleep, 385)
PLAT_STUB(slpManPlatVoteEnableSleep, 386)
PLAT_STUB(slpManProductionTest, 387)
PLAT_STUB(slpManRegisterPredefinedBackupCb, 388)
PLAT_STUB(slpManRegisterPredefinedRestoreCb, 389)
PLAT_STUB(slpManSetDrvVoteMask, 390)
PLAT_STUB(slpManSetPmuSleepMode, 391)
PLAT_STUB(slpManSetWakeupPadCfg, 392)
PLAT_STUB(slpManStartPowerOff, 393)
PLAT_STUB(slpManUnregisterPredefinedBackupCb, 394)
PLAT_STUB(slpManUnregisterPredefinedRestoreCb, 395)
PLAT_STUB(slpManUpdatePmuTimingCfg, 396)
PLAT_STUB(snprintf, 397)
PLAT_STUB(soc_call_function_in_service, 398)
PLAT_STUB(soc_cms_proc, 399)
PLAT_STUB(soc_disable_tcpip_use_default_pdp, 400)
PLAT_STUB(soc_fast_printf, 401)
PLAT_STUB(soc_free_later, 402)
PLAT_STUB(soc_get_poweron_time_ms, 403)
PLAT_STUB(soc_get_poweron_time_tick, 404)
PLAT_STUB(soc_info, 405)
PLAT_STUB(soc_mobile_default_pdn_ip_type, 406)
PLAT_STUB(soc_mobile_search_cell_info_async, 407)
PLAT_STUB(soc_mobile_set_rrc_release_time, 408)
PLAT_STUB(soc_netif_input_prepare, 409)
PLAT_STUB(soc_power_mode, 410)
PLAT_STUB(soc_printf, 411)
PLAT_STUB(soc_set_usb_sleep, 412)
PLAT_STUB(soc_uart0_set_log_off, 413)
PLAT_STUB(soc_unilog_callback, 414)
PLAT_STUB(soc_usb_onoff, 415)
PLAT_STUB(soc_usb_serial_output, 416)
PLAT_STUB(soc_vsprintf, 417)
PLAT_STUB(sprintf, 418)
PLAT_STUB(sqrt, 419)
PLAT_STUB(srand, 420)
PLAT_STUB(sscanf, 421)
PLAT_STUB(strcat, 422)
PLAT_STUB(strchr, 423)
PLAT_STUB(strcmp, 424)
PLAT_STUB(strcpy, 425)
PLAT_STUB(strcspn, 426)
PLAT_STUB(strdup, 427)
PLAT_STUB(strerror, 428)
PLAT_STUB(strlen, 429)
PLAT_STUB(strncat, 430)
PLAT_STUB(strncmp, 431)
PLAT_STUB(strncpy, 432)
PLAT_STUB(strnlen, 433)
PLAT_STUB(strspn, 434)
PLAT_STUB(strstr, 435)
PLAT_STUB(strtod, 436)
PLAT_STUB(strtoul, 437)
PLAT_STUB(tan, 438)
PLAT_STUB(tanh, 439)
PLAT_STUB(tcp_accept, 440)
PLAT_STUB(tcp_arg, 441)
PLAT_STUB(tcp_bind, 442)
PLAT_STUB(tcp_close, 443)
PLAT_STUB(tcp_connect, 444)
PLAT_STUB(tcp_err, 445)
PLAT_STUB(tcp_listen_with_backlog, 446)
PLAT_STUB(tcp_new, 447)
PLAT_STUB(tcp_output, 448)
PLAT_STUB(tcp_recv, 449)
PLAT_STUB(tcp_recved, 450)
PLAT_STUB(tcp_sent, 451)
PLAT_STUB(tcp_shutdown, 452)
PLAT_STUB(tcp_write, 453)
PLAT_STUB(tcpip_callback_with_block, 454)
PLAT_STUB(trimAdcSetGolbalVar, 455)
PLAT_STUB(trunc, 456)
PLAT_STUB(tzset, 457)
PLAT_STUB(udp_bind, 458)
PLAT_STUB(udp_connect, 459)
PLAT_STUB(udp_new, 460)
PLAT_STUB(udp_recv, 461)
PLAT_STUB(udp_remove, 462)
PLAT_STUB(udp_send, 463)
PLAT_STUB(udp_sendto, 464)
PLAT_STUB(vPortGetHeapStats, 465)
PLAT_STUB(vPortGetHeapTag, 466)
PLAT_STUB(vPortIterateAllocations, 467)
PLAT_STUB(vPortSetHeapTag, 468)
PLAT_STUB(vQueueDelete, 469)
PLAT_STUB(vTaskDelete, 470)
PLAT_STUB(vfprintf, 471)
PLAT_STUB(vsnprintf, 472)
PLAT_STUB(xQueueCreateMutex, 473)
PLAT_STUB(xQueueGenericCreate, 474)
PLAT_STUB(xQueueGenericReceive, 475)
PLAT_STUB(xQueueGenericSend, 476)
PLAT_STUB(xQueueGenericSendFromISR, 477)
PLAT_STUB(xQueueGetMutexHolder, 478)
PLAT_STUB(xTaskCreate, 479)
PLAT_STUB(xTaskGenericNotify, 480)
PLAT_STUB(xTaskGetCurrentTaskHandle, 481)
PLAT_STUB(xTaskNotifyWait, 482)
